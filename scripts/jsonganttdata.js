var resources = [
 ...
 { Id: 3, Name: "David William" },
 { Id: 4, Name: "Nancy Davolio" },
 { Id: 5, Name: "Janet Leverling" },
 { Id: 6, Name: "Romey Wilson" }
];
var histoResourcesData = [
    {
        "TaskId": 1,
        ...
        "Progress": 70,
        "Children": [
            { "TaskId": 2, "TaskName": "Plan budget", "StartDate": new Date("10/23/2017"), "Duration": 4, "Progress": 80, "Resources": [1, 4] },
            { "TaskId": 3, "TaskName": "Allocate resources", "StartDate": new Date("10/24/2017"), "Duration": 5, "Progress": 65, "Predecessor": "2", "Resources": [3, 1]},
            { "TaskId": 4, "TaskName": "Software Specification", "StartDate": new Date("10/24/2017"), "Duration": 5, "Progress": 65, "Predecessor": "2", "Resources": [5,4] },            
        ]
    },
    {
        "TaskId": 5,
        ...
        "Progress": 77,
        "Children": [
            { "TaskId": 6, "TaskName": "Get approval from customer", "StartDate": new Date("10/28/2017"), "Duration": 5, "Progress": 60, "Resources": [2,5] },
            { "TaskId": 7, "TaskName": "Testing", "StartDate": new Date("10/29/2017"), "Duration": 6, "Progress": 77, "Predecessor": "5", "Resources": [6,7] },
            { "TaskId": 8, "TaskName": "Final Delivery", "StartDate": new Date("10/29/2017"), "Duration": 0, "Progress": 0, "Predecessor": "6", "Resources": [3] }
        ]
}];
var dayData = [
          {
        ...
        subtasks: [
            {
                ...
                subtasks: [
                    ...
                    { taskID: 6, taskName: "Planning complete", startDate: new Date( "02/06/2017"), duration: 0, predecessor: "3FS,5FS", resourceId: [1] }
                ]
            },
            {
                taskID: 7,
                ...
                progressColor: "#7AA992",
                subtasks: [
                    { taskID: 8, taskName: "Software Specification", duration: 3, progress: "60", resourceInfo: [2] },
                    { taskID: 9, taskName: "Develop prototype", startDate: new Date( "02/03/2017"), endDate: new Date( "02/8/2017"), progress: "40", resourceInfo: [3], predecessor: "8FS" },
                    { taskID: 10, taskName: "Get approval from customer", startDate: new Date("02/7/2017"), endDate: new Date( "02/9/2017"), progress: "50", predecessor:"9FS", resourceInfo: [1] },
                    { taskID: 11, taskName: "Design complete",startDate: new Date( "02/03/2017"), endDate: new Date( "02/09/2017"), duration: 3, predecessor:"10FS" }
                ]
            },            
        ]
    }
